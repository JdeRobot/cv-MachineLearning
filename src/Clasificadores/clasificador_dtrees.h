...
namespace MLT {
    ...
    public:
        Clasificador_DTrees(string Nombre="",int max_depth=INT_MAX, int min_sample_count=10, float regression_accuracy=0.01, bool use_surrogates=true, int max_categories=10, int cv_folds=0, bool use_1se_rule=true, bool truncate_pruned_tree=true, Mat priors=Mat());
        ~Clasificador_DTrees();
